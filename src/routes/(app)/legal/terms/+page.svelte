...
<main class="container mx-auto my-6">
  <div class="hero">
    <div class="hero-content text-center">
      <div class="max-w-lg">
        <h1 class="text-3xl md:text-5xl font-bold">Terms Of Service</h1>
        <p class="py-6 text-secondary">Last updated: 05/24/2023</p>
      </div>
    </div>
  </div>


  <h2 class="text-xl md:text-2xl font-bold mb-3">Introduction</h2>
  <p class="py-2">
    Welcome to Mobile Greaser Technologies, Inc. (“Company”, “we”, “our”, “us”)! As you have just clicked our
  ...
  <p class="py-2">
    These Terms of Service (“Terms”, “Terms of Service”) govern your use of our mobile
    application Greaser operated by Mobile Greaser Technologies, Inc.
  </p>
  <p class="py-2">
    ...
    Please read it here https://mobilegreaser.com/legal/privacy.
  </p>
  <p class="py-2">
  ...
  <p class="py-2">
    ...
    know by emailing at team@mobilegreaser.com so we can try to find a solution. These Terms apply to all visitors,
  ...
  <h2 class="text-xl md:text-2xl font-bold my-3">Communications</h2>
  <p class="py-2">
  ...
  <h2 class="text-xl md:text-2xl font-bold my-3">Purchases</h2>
  ...
  <p class="py-2">
    ...
    or service availability, errors in the description or price of the product or service, error in your order or
    other reasons.
  </p>
  ...
  <h2 class="text-xl md:text-2xl font-bold my-3">Subscriptions</h2>
  ...
  <p class="py-2">
    ...
    you cancel it or Mobile Greaser Technologies, Inc. cancels it. You may cancel your Subscription renewal either
    through your online account management page or by contacting Mobile Greaser Technologies, Inc. customer support
    team.
  </p>

  <p class="py-2">
    A valid payment method, including credit card or PayPal, is required to process the payment for your subscription.
    You shall provide Mobile Greaser Technologies, Inc. with accurate and complete billing information including full
    name, address, state, zip code, telephone number, and a valid payment method information. By submitting such payment
    information, you automatically authorize Mobile Greaser Technologies, Inc. to charge all Subscription fees incurred
    through your account to any such payment instruments.
  </p>

  <p class="py-2">
    Should automatic billing fail to occur for any reason, Mobile Greaser Technologies, Inc. will issue
    an electronic invoice indicating that you must proceed manually, within a certain deadline date, with the full
    payment corresponding to the billing period as indicated on the invoice.
  </p>

  <h2 class="text-xl md:text-2xl font-bold my-3">Fee Changes</h2>

  <p class="py-2">
    Mobile Greaser Technologies, Inc., in its sole discretion and at any time, may modify Subscription
    fees for the Subscriptions. Any Subscription fee change will become effective at the end of the then-current Billing
    Cycle.
  </p>

  <p class="py-2">
    Mobile Greaser Technologies, Inc. will provide you with a reasonable prior notice of any change in
  ...
  <h2 class="text-xl md:text-2xl font-bold my-3">Refunds</h2>
  <p class="py-2">Except when required by law, paid Subscription fees are non-refundable.</p>

  <h2 class="text-xl md:text-2xl font-bold my-3">Content</h2>
  <p class="py-2">
    Our Service allows you to post, link, store, share and otherwise make available certain information,
    text, graphics, videos, or other material (“Content”). You are responsible for Content that you post on or through
    Service, including its legality, reliability, and appropriateness.
  </p>

  <p class="py-2">
    By posting Content on or through Service, You represent and warrant that: (i) Content is yours (you
    own it) and/or you have the right to use it and the right to grant us the rights and license as provided in these
    Terms, and (ii) that the posting of your Content on or through Service does not violate the privacy rights,
    publicity rights, copyrights, contract rights or any other rights of any person or entity. We reserve the right to
  ...
  <p class="py-2">
    ...
    Service and you are responsible for protecting those rights. We take no responsibility and assume no liability for
    Content you or any third party posts on or through Service. However, by posting Content using Service you grant us
    the right and license to use, modify, publicly perform, publicly display, reproduce, and distribute such Content on
    and through Service. You agree that this license includes the right for us to make your Content available to other
    users of Service, who may also use your Content subject to these Terms.
  </p>

  <p class="py-2">
    Mobile Greaser Technologies, Inc. has the right but not the obligation to monitor and edit all
    Content provided by users.
  </p>

  <p class="py-2">
    In addition, Content found on or through this Service are the property of Mobile Greaser
    Technologies, Inc. or used with permission. You may not distribute, modify, transmit, reuse, download, repost, copy,
    or use said Content, whether in whole or in part, for commercial purposes or for personal gain, without express
    advance written permission from us.
  </p>

  <h2 class="text-xl md:text-2xl font-bold my-3">Prohibited Uses</h2>
  ...
  <ul class="list-inside pl-4">
    <li class="list-disc">In any way that violates any applicable national or international law or regulation.</li>
  ...
  <p class="py-2">Additionally, you agree not to:</p>

  <ul class="list-inside pl-4">
    <li class="list-disc">
      Use Service in any manner that could disable, overburden, damage, or impair Service or
      interfere with any other party’s use of Service, including their ability to engage in real time activities through
      Service.
    </li>
    ...
    <li class="list-disc">Use any device, software, or routine that interferes with the proper working of Service.</li>
    ...
    <li class="list-disc">
      ...
      Service, the server on which Service is stored, or any server, computer, or database connected to Service.
    </li>

    <li class="list-disc">Attack Service via a denial-of-service attack or a distributed denial-of-service attack.</li>

    <li class="list-disc">Take any action that may damage or falsify Company rating.</li>

    <li class="list-disc">Otherwise attempt to interfere with the proper working of Service.</li>
  </ul>

  <h2 class="text-xl md:text-2xl font-bold my-3">No Use By Minors</h2>

  <p class="py-2">
    Service is intended only for access and use by individuals at least eighteen (18) years old. By
    accessing or using any of Company, you warrant and represent that you are at least eighteen (18) years of age and
    with the full authority, right, and capacity to enter into this agreement and abide by all of the terms and
    conditions of Terms. If you are not at least eighteen (18) years old, you are prohibited from both the access and
    usage of Service.
  </p>

  <h2 class="text-xl md:text-2xl font-bold my-3">Accounts</h2>
  <p class="py-2">
    When you create an account with us, you guarantee that you are above the age of 18, and that the
    information you provide us is accurate, complete, and current at all times. Inaccurate, incomplete, or obsolete
  ...
  <p class="py-2">
    ...
    and all activities or actions that occur under your account and/or password, whether your password is with our
    Service or a third-party service. You must notify us immediately upon becoming aware of any breach of security or
    unauthorized use of your account.
  </p>

  <p class="py-2">
    You may not use as a username the name of another person or entity or that is not lawfully available
    for use, a name or trademark that is subject to any rights of another person or entity other than you, without
  ...
  <h2 class="text-xl md:text-2xl font-bold my-3">Intellectual Property</h2>
  <p class="py-2">
    Service and its original content (excluding Content provided by users), features and functionality
    are and will remain the exclusive property of Mobile Greaser Technologies, Inc. and its licensors. Service is
    protected by copyright, trademark, and other laws of the United States. Our trademarks and trade dress may not be
    used in connection with any product or service without the prior written consent of Mobile Greaser Technologies,
    Inc..
  </p>

  <h2 class="text-xl md:text-2xl font-bold my-3">Error Reporting and Feedback</h2>
  <p class="py-2">
    You may provide us directly at team@mobilegreaser.com with information and feedback concerning
    errors, suggestions for improvements, ideas, problems, complaints, and other matters related to our Service
    (“Feedback”). You acknowledge and agree that: (i) you shall not retain, acquire or assert any intellectual property
    right or other right, title or interest in or to the Feedback; (ii) Company may have development ideas similar to
    the Feedback; (iii) Feedback does not contain confidential information or proprietary information from you or any
    third party; and (iv) Company is not under any obligation of confidentiality with respect to the Feedback. In the
    event the transfer of the ownership to the Feedback is not possible due to applicable mandatory laws, you grant
    Company and its affiliates an exclusive, transferable, irrevocable, free-of-charge, sub-licensable, unlimited and
    perpetual right to use (including copy, modify, create derivative works, publish, distribute and commercialize)
    Feedback in any manner and for any purpose.
  </p>

  <h2 class="text-xl md:text-2xl font-bold my-3">Links To Other Web Sites</h2>
  <p class="py-2">
    Our Service may contain links to third party web sites or services that are not owned or controlled
    by Mobile Greaser Technologies, Inc.
  </p>

  <p class="py-2">
    Mobile Greaser Technologies, Inc. has no control over, and assumes no responsibility for the content,
  ...
  <p class="py-2">
    YOU ACKNOWLEDGE AND AGREE THAT Mobile Greaser Technologies, Inc. SHALL NOT BE RESPONSIBLE OR LIABLE,
  ...
  <h2 class="text-xl md:text-2xl font-bold my-3">Disclaimer Of Warranty</h2>
  <p class="py-2">
  ...
  <p class="py-2">
    ...
    LIMITING THE FOREGOING, NEITHER COMPANY NOR ANYONE ASSOCIATED WITH COMPANY REPRESENTS OR WARRANTS THAT THE SERVICES,
  ...
  <h2 class="text-xl md:text-2xl font-bold my-3">Limitation Of Liability</h2>
  <p class="py-2">
    ...
    PERSONAL INJURY OR PROPERTY DAMAGE, ARISING FROM THIS AGREEMENT AND ANY VIOLATION BY YOU OF ANY FEDERAL, STATE, OR
    LOCAL LAWS, STATUTES, RULES, OR REGULATIONS, EVEN IF COMPANY HAS BEEN PREVIOUSLY ADVISED OF THE POSSIBILITY OF SUCH
    DAMAGE. EXCEPT AS PROHIBITED BY LAW, IF THERE IS LIABILITY FOUND ON THE PART OF COMPANY, IT WILL BE LIMITED TO THE
    AMOUNT PAID FOR THE PRODUCTS AND/OR SERVICES, AND UNDER NO CIRCUMSTANCES WILL THERE BE CONSEQUENTIAL OR PUNITIVE
    DAMAGES. SOME STATES DO NOT ALLOW THE EXCLUSION OR LIMITATION OF PUNITIVE, INCIDENTAL OR CONSEQUENTIAL DAMAGES, SO
    THE PRIOR LIMITATION OR EXCLUSION MAY NOT APPLY TO YOU.
  </p>

  <h2 class="text-xl md:text-2xl font-bold my-3">Termination</h2>
  <p class="py-2">
    We may terminate or suspend your account and bar access to Service immediately, without prior notice
    or liability, under our sole discretion, for any reason whatsoever and without limitation, including but not limited
    to a breach of Terms.
  </p>

  <p class="py-2">If you wish to terminate your account, you may simply discontinue using Service.</p>
  ...
  <h2 class="text-xl md:text-2xl font-bold my-3">Governing Law</h2>
  <p class="py-2">
    These Terms shall be governed and construed in accordance with the laws of State of Delaware without
    regard to its conflict of law provisions.
  </p>

  <p class="py-2">
    Our failure to enforce any right or provision of these Terms will not be considered a waiver of those
    rights. If any provision of these Terms is held to be invalid or unenforceable by a court, the remaining provisions
  ...
  <h2 class="text-xl md:text-2xl font-bold my-3">Changes To Service</h2>
  <p class="py-2">
    We reserve the right to withdraw or amend our Service, and any service or material we provide via
    Service, in our sole discretion without notice. We will not be liable if for any reason all or any part of Service
    is unavailable at any time or for any period. From time to time, we may restrict access to some parts of Service, or
    the entire Service, to users, including registered users.
  </p>

  <h2 class="text-xl md:text-2xl font-bold my-3">Amendments To Terms</h2>
  <p class="py-2">
  ...
  <p class="py-2">
    ...
    agree to the changes. You are expected to check this page frequently so you are aware of any changes, as they are
    binding on you.
  </p>

  <p class="py-2">
    By continuing to access or use our Service after any revisions become effective, you agree to be
    bound by the revised terms. If you do not agree to the new terms, you are no longer authorized to use Service.
  </p>

  <h2 class="text-xl md:text-2xl font-bold my-3">Waiver And Severability</h2>
  <p class="py-2">
    No waiver by Company of any term or condition set forth in Terms shall be deemed a further or
    continuing waiver of such term or condition or a waiver of any other term or condition, and any failure of Company
  ...
  <h2 class="text-xl md:text-2xl font-bold my-3">Acknowledgement</h2>
  <p class="py-2">
  ...
  <h2 class="text-xl md:text-2xl font-bold my-3">Contact Us</h2>
  <p class="py-2">Please send your feedback, comments, requests for technical support:</p>
  <p class="py-2">By email: team@mobilegreaser.com.</p>
